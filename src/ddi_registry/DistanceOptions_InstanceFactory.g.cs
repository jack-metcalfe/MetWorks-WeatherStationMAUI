...
namespace ServiceRegistry
{
    ...
    internal static partial class DistanceOptions_InstanceFactory
    {
        public static System.String[] Create(Registry registry)
        {
            ...
            var instance = DistanceOptions_ElementsInitializer.CreateElements(registry);

            // Register immediately so other instances can reference it.
            registry.RegisterDistanceOptions(instance);
