...
namespace ServiceRegistry
{
    ...
    internal static partial class TheRawPacketRecordTypedInPostgresOut_Initializer
    {
        public static async Task Initialize_TheRawPacketRecordTypedInPostgresOutAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheRawPacketRecordTypedInPostgresOut_Internal();
            ...
            await instance.InitializeAsync(
                ...
                // Parameter: iSettingsRepository: registry.GetThePostgresSettingsRepository()
                iSettingsRepository: registry.GetThePostgresSettingsRepository(),
