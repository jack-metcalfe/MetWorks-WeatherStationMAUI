...
namespace ServiceRegistry
{
    ...
    internal static partial class PrecipitationOptions_InstanceFactory
    {
        public static System.String[] Create(Registry registry)
        {
            // Element-driven instance: build via ElementsInitializer.
            // This always returns the concrete class of the named instance.
            var instance = PrecipitationOptions_ElementsInitializer.CreateElements(registry);

            // Register immediately so other instances can reference it.
            registry.RegisterPrecipitationOptions(instance);
