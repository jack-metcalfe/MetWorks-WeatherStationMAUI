...
namespace ServiceRegistry
{
    ...
    internal static partial class ThePostgresSettingsRepository_Initializer
    {
        public static async Task Initialize_ThePostgresSettingsRepositoryAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetThePostgresSettingsRepository_Internal();
            ...
            await instance.InitializeAsync(
                ...
                // Parameter: settingConfigurations: registry.GetThePostgresSettings_Internal()
                settingConfigurations: registry.GetThePostgresSettings_Internal(),
