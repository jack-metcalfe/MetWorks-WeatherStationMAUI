...
namespace ServiceRegistry
{
    ...
    internal static partial class TheWeatherDataTransformer_Initializer
    {
        public static async Task Initialize_TheWeatherDataTransformerAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheWeatherDataTransformer_Internal();
