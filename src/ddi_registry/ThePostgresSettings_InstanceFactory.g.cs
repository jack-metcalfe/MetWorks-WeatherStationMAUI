...
namespace ServiceRegistry
{
    ...
    internal static partial class ThePostgresSettings_InstanceFactory
    {
        public static Settings.SettingConfiguration[] Create(Registry registry)
        {
            ...
            var instance = ThePostgresSettings_ElementsInitializer.CreateElements(registry);

            // Register immediately so other instances can reference it.
            registry.RegisterThePostgresSettings(instance);
