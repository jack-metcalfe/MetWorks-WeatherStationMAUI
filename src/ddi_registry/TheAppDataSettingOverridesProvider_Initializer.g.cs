...
namespace ServiceRegistry
{
    ...
    internal static partial class TheAppDataSettingOverridesProvider_Initializer
    {
        public static async Task Initialize_TheAppDataSettingOverridesProviderAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheAppDataSettingOverridesProvider_Internal();
            ...
            await instance.InitializeAsync(
                // Parameter: filename: "TheOverridesFile.ovr"
                filename: "TheOverridesFile.ovr"
            );
        }
    }
}