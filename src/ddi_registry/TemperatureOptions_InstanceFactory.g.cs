...
namespace ServiceRegistry
{
    ...
    internal static partial class TemperatureOptions_InstanceFactory
    {
        public static System.String[] Create(Registry registry)
        {
            ...
            var instance = TemperatureOptions_ElementsInitializer.CreateElements(registry);

            // Register immediately so other instances can reference it.
            registry.RegisterTemperatureOptions(instance);
