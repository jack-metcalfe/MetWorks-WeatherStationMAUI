...
namespace ServiceRegistry
{
    ...
    internal static partial class TheProvenanceTracker_Initializer
    {
        public static async Task Initialize_TheProvenanceTrackerAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheProvenanceTracker_Internal();
