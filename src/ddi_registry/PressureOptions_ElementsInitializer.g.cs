...
namespace ServiceRegistry
{
    ...
    internal static partial class PressureOptions_ElementsInitializer
    {
        public static System.String[] CreateElements(Registry registry)
        {
            // Construct the instance using element-driven values.
            return new System.String[] { "atmosphere", "bar", "hectopascal", "inch of mercury", "kilopascal", "millibar", "pascal" };
        }
    }
}
