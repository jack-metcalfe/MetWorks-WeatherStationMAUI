...
namespace ServiceRegistry
{
    ...
    internal static partial class TheSettingProvider_Initializer
    {
        public static async Task Initialize_TheSettingProviderAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheSettingProvider_Internal();
