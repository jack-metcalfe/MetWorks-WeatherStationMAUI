...
namespace ServiceRegistry
{
    ...
    internal static partial class WindspeedOptions_InstanceFactory
    {
        public static System.String[] Create(Registry registry)
        {
            ...
            var instance = WindspeedOptions_ElementsInitializer.CreateElements(registry);

            // Register immediately so other instances can reference it.
            registry.RegisterWindspeedOptions(instance);
