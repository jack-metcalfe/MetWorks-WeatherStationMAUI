    ...
    )
    {
        ...
        try
        {
            ...
            _bufferingEnabled = iSettingRepository.GetValueOrDefault<bool>(
                        GroupSettingDefinitions.XMLToPostgreSQLGroupSettingsDefinition.BuildSettingPath(GroupSettingDefinitions.XMLToPostgreSQL_enableBuffering)
                    );
            ...
            _connectionString = iSettingRepository.GetValueOrDefault<string>(
                GroupSettingDefinitions.XMLToPostgreSQLGroupSettingsDefinition.BuildSettingPath(GroupSettingDefinitions.XMLToPostgreSQL_connectionString)
            );
