...
public class SensorReadingTransformer : ServiceBase
{
    ...
    )
    {
        try
        {
            ...
            IEventRelayPath.Register(GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.GroupBasePath, OnUnitSettingChanged);
    ...
    bool LoadUnitPreference(ISettingRepository iSettingsRepository, ILogger iLogger)
    {
        try
        {
            var unitOfMeasure_airPressure = iSettingsRepository.GetValueOrDefault<string>(
                    GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.BuildSettingPath(MeasurementHelper.UnitOfMeasure_airPressure)
                );
            ...
            var unitOfMeasure_airTemperature = iSettingsRepository.GetValueOrDefault<string>(
                    GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.BuildSettingPath(MeasurementHelper.UnitOfMeasure_airTemperature)
                );
            ...
            var unitOfMeasure_lightningDistance = iSettingsRepository.GetValueOrDefault<string>(
                    GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.BuildSettingPath(MeasurementHelper.UnitOfMeasure_lightningDistance)
                );
            ...
            var unitOfMeasure_precipitationAmount = iSettingsRepository.GetValueOrDefault<string>(
                    GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.BuildSettingPath(MeasurementHelper.UnitOfMeasure_precipitationAmount)
                );
            ...
            var unitOfMeasure_windSpeed = iSettingsRepository.GetValueOrDefault<string>(
                    GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.BuildSettingPath(MeasurementHelper.UnitOfMeasure_windSpeed)
                );
    ...
    protected override Task OnDisposeAsync()
    {
        try
        {
            ...
            try { IEventRelayPath?.Unregister(GroupSettingDefinitions.UnitOfMeasureGroupSettingsDefinition.GroupBasePath, OnUnitSettingChanged); } catch { /* swallow */ }
