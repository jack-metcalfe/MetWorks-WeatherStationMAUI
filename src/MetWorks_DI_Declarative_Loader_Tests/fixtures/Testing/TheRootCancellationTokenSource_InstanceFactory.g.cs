...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheRootCancellationTokenSource_InstanceFactory
    {
        public static System.Threading.CancellationTokenSource Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new System.Threading.CancellationTokenSource();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheRootCancellationTokenSource(instance);
