...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStreamShippingDatabaseReadiness_Initializer
    {
        public static async Task Initialize_TheStreamShippingDatabaseReadinessAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheStreamShippingDatabaseReadiness_Internal();
