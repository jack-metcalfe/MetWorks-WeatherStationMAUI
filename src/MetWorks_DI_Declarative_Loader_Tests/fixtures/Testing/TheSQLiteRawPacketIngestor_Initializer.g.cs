...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheSQLiteRawPacketIngestor_Initializer
    {
        public static async Task Initialize_TheSQLiteRawPacketIngestorAsync(Registry registry)
        {
            ...
            await instance.InitializeAsync(
                ...
                rawPacketDatabaseReadiness: registry.GetTheRawPacketDatabaseReadiness(),
                rawPacketIngestRepository: registry.GetTheRawPacketIngestRepository(),
