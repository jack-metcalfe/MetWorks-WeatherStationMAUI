namespace RedStar.Amounts.StandardUnits
{
    ...
    public static class TemperatureUnits
    {
        ...
        public static readonly Unit DegreeCelsius = new Unit("degree celsius", "°C", new UnitType("celsius temperature"));
        ...
        public static void RegisterConversions()
        {
            ...
            {
                return new Amount((amount.Value - 32.0) / 9.0 * 5.0, DegreeCelsius);
            }
                );
