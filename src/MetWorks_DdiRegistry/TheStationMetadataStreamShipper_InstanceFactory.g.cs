...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStationMetadataStreamShipper_InstanceFactory
    {
        public static MetWorks.Ingest.SQLite.Shipping.StationMetadataStreamShipper Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.SQLite.Shipping.StationMetadataStreamShipper();

            // Register immediately so other instances can reference it.
            registry.RegisterTheStationMetadataStreamShipper(instance);
