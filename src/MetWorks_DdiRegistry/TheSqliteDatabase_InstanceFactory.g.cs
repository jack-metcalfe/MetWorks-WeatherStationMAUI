...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheSqliteDatabase_InstanceFactory
    {
        public static MetWorks.Data.Sqlite.SqliteDatabase Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Data.Sqlite.SqliteDatabase();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheSqliteDatabase(instance);
