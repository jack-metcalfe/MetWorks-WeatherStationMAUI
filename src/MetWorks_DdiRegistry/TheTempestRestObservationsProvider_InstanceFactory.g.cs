...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheTempestRestObservationsProvider_InstanceFactory
    {
        public static MetWorks.Common.TempestRestObservationsProvider Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.TempestRestObservationsProvider();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheTempestRestObservationsProvider(instance);
