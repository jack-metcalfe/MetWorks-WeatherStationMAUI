...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheObservationStreamShipper_Initializer
    {
        public static async Task Initialize_TheObservationStreamShipperAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheObservationStreamShipper_Internal();
