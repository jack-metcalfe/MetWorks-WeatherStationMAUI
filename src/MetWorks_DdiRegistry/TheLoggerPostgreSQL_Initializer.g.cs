...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheLoggerPostgreSQL_Initializer
    {
        public static async Task Initialize_TheLoggerPostgreSQLAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheLoggerPostgreSQL_Internal();
