...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStreamShippingHttpClientProvider_InstanceFactory
    {
        public static MetWorks.Common.Networking.StreamShippingHttpClientProvider Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.Networking.StreamShippingHttpClientProvider();

            // Register immediately so other instances can reference it.
            registry.RegisterTheStreamShippingHttpClientProvider(instance);
