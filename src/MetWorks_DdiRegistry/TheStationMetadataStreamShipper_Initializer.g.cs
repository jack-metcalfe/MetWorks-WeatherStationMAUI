...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStationMetadataStreamShipper_Initializer
    {
        public static async Task Initialize_TheStationMetadataStreamShipperAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheStationMetadataStreamShipper_Internal();
