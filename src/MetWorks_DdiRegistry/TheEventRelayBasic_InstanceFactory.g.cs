...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheEventRelayBasic_InstanceFactory
    {
        public static MetWorks.EventRelay.EventRelayBasic Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.EventRelay.EventRelayBasic();

            // Register immediately so other instances can reference it.
            registry.RegisterTheEventRelayBasic(instance);
