...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheSQLiteRawPacketIngestor_InstanceFactory
    {
        public static MetWorks.Ingest.SQLite.RawPacketIngestor Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.SQLite.RawPacketIngestor();

            // Register immediately so other instances can reference it.
            registry.RegisterTheSQLiteRawPacketIngestor(instance);
