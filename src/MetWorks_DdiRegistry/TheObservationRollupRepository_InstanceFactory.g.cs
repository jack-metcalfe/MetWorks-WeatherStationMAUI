...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheObservationRollupRepository_InstanceFactory
    {
        public static MetWorks.Persistence.Rollups.ObservationRollupRepository Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Persistence.Rollups.ObservationRollupRepository();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheObservationRollupRepository(instance);
