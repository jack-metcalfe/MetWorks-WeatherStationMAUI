...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheSQLiteStationMetadataIngestor_InstanceFactory
    {
        public static MetWorks.Ingest.SQLite.StationMetadataIngestor Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.SQLite.StationMetadataIngestor();

            // Register immediately so other instances can reference it.
            registry.RegisterTheSQLiteStationMetadataIngestor(instance);
