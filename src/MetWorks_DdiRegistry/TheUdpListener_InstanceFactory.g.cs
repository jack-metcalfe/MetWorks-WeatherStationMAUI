...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheUdpListener_InstanceFactory
    {
        public static MetWorks.Networking.Udp.Transformer.TempestPacketTransformer Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Networking.Udp.Transformer.TempestPacketTransformer();

            // Register immediately so other instances can reference it.
            registry.RegisterTheUdpListener(instance);
