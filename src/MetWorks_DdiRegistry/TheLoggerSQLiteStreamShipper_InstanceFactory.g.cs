...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheLoggerSQLiteStreamShipper_InstanceFactory
    {
        public static MetWorks.Ingest.SQLite.Shipping.LoggerSQLiteStreamShipper Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.SQLite.Shipping.LoggerSQLiteStreamShipper();

            // Register immediately so other instances can reference it.
            registry.RegisterTheLoggerSQLiteStreamShipper(instance);
