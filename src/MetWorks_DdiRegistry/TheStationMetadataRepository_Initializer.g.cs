...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStationMetadataRepository_Initializer
    {
        public static async Task Initialize_TheStationMetadataRepositoryAsync(Registry registry)
        {
