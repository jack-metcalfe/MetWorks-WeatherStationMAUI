...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheTempestOAuthTokenProvider_InstanceFactory
    {
        public static MetWorks.Maui.Services.TempestOAuthTokenProvider Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Maui.Services.TempestOAuthTokenProvider();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheTempestOAuthTokenProvider(instance);
