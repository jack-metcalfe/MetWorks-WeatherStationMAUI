...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class ThePostgresStationMetadataIngestor_InstanceFactory
    {
        public static MetWorks.Ingest.Postgres.StationMetadataIngestor Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.Postgres.StationMetadataIngestor();

            // Register immediately so other instances can reference it.
            registry.RegisterThePostgresStationMetadataIngestor(instance);
