...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStationMetadataProvider_InstanceFactory
    {
        public static MetWorks.Common.StationMetadataProvider Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.StationMetadataProvider();

            // Register immediately so other instances can reference it.
            registry.RegisterTheStationMetadataProvider(instance);
