...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheMetricsSampler_Initializer
    {
        public static async Task Initialize_TheMetricsSamplerAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheMetricsSampler_Internal();
            ...
            await instance.InitializeAsync(
                ...
                metricsSummaryIngestor: registry.GetTheMetricsSummaryIngestor(),
