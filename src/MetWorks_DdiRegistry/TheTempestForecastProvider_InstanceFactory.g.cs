...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheTempestForecastProvider_InstanceFactory
    {
        public static MetWorks.Common.TempestForecastProvider Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.TempestForecastProvider();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheTempestForecastProvider(instance);
