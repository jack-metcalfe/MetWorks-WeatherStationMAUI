...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheSqliteWriteCoordinator_InstanceFactory
    {
        public static MetWorks.Common.Utility.SqliteWriteCoordinator Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.Utility.SqliteWriteCoordinator();

            // Register immediately so other instances can reference it.
            registry.RegisterTheSqliteWriteCoordinator(instance);
