...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheMetricsSummaryIngestor_Initializer
    {
        public static async Task Initialize_TheMetricsSummaryIngestorAsync(Registry registry)
        {
            ...
            await registry.WhenTheMetricsDatabaseReadinessInitializedAsync().ConfigureAwait(false);
            await registry.WhenTheMetricsSummaryRepositoryInitializedAsync().ConfigureAwait(false);
            ...
            await instance.InitializeAsync(
                ...
                metricsDatabaseReadiness: registry.GetTheMetricsDatabaseReadiness(),
                metricsSummaryRepository: registry.GetTheMetricsSummaryRepository(),
