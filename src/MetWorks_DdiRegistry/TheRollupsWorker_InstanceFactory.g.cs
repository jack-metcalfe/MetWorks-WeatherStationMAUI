...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheRollupsWorker_InstanceFactory
    {
        public static MetWorks.Ingest.SQLite.Rollups.RollupsWorker Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.SQLite.Rollups.RollupsWorker();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheRollupsWorker(instance);
