...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheTempestOAuthTokenProvider_Initializer
    {
        public static async Task Initialize_TheTempestOAuthTokenProviderAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheTempestOAuthTokenProvider_Internal();
