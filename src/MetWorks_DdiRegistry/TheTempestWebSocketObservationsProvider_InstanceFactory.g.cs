...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheTempestWebSocketObservationsProvider_InstanceFactory
    {
        public static MetWorks.Common.TempestWebSocketObservationsProvider Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.TempestWebSocketObservationsProvider();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheTempestWebSocketObservationsProvider(instance);
