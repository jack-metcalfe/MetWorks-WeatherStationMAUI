...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheLoggerSqliteRepository_InstanceFactory
    {
        public static MetWorks.Persistence.Logging.LoggerSqliteRepository Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Persistence.Logging.LoggerSqliteRepository();

            // Register immediately so other instances can reference it.
            registry.RegisterTheLoggerSqliteRepository(instance);
