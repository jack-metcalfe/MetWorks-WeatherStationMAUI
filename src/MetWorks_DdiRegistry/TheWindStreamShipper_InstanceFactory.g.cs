...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheWindStreamShipper_InstanceFactory
    {
        public static MetWorks.Ingest.SQLite.Shipping.WindStreamShipper Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Ingest.SQLite.Shipping.WindStreamShipper();

            // Register immediately so other instances can reference it.
            registry.RegisterTheWindStreamShipper(instance);
