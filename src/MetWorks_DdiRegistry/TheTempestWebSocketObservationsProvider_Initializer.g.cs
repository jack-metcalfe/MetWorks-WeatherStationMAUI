...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheTempestWebSocketObservationsProvider_Initializer
    {
        public static async Task Initialize_TheTempestWebSocketObservationsProviderAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheTempestWebSocketObservationsProvider_Internal();
            ...
            await registry.WhenTheTempestOAuthTokenProviderInitializedAsync().ConfigureAwait(false);
            ...
            await instance.InitializeAsync(
                ...
                iTempestOAuthTokenProvider: registry.GetTheTempestOAuthTokenProvider(),
