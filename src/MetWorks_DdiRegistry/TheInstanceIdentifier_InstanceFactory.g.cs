...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheInstanceIdentifier_InstanceFactory
    {
        public static MetWorks.InstanceIdentifier.InstanceIdentifier Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.InstanceIdentifier.InstanceIdentifier();

            // Register immediately so other instances can reference it.
            registry.RegisterTheInstanceIdentifier(instance);
