...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheWeatherReadingMux_Initializer
    {
        public static async Task Initialize_TheWeatherReadingMuxAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheWeatherReadingMux_Internal();
