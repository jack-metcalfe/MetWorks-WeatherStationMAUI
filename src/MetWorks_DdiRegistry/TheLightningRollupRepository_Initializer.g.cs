...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheLightningRollupRepository_Initializer
    {
        public static async Task Initialize_TheLightningRollupRepositoryAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheLightningRollupRepository_Internal();
