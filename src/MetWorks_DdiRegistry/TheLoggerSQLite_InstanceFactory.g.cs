...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheLoggerSQLite_InstanceFactory
    {
        public static MetWorks.Common.Logging.LoggerSQLite Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Common.Logging.LoggerSQLite();

            // Register immediately so other instances can reference it.
            registry.RegisterTheLoggerSQLite(instance);
