...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class ThePrecipitationRollupRepository_Initializer
    {
        public static async Task Initialize_ThePrecipitationRollupRepositoryAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetThePrecipitationRollupRepository_Internal();
