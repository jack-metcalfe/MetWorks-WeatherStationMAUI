...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheStationMetadataRepository_InstanceFactory
    {
        public static MetWorks.Persistence.StationMetadata.StationMetadataRepository Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Persistence.StationMetadata.StationMetadataRepository();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheStationMetadataRepository(instance);
