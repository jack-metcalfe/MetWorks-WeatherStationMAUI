...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheRawPacketIngestRepository_Initializer
    {
        public static async Task Initialize_TheRawPacketIngestRepositoryAsync(Registry registry)
        {
            // Step 1: retrieve the created instance from the registry.
            // Internal accessor ensures we always get the concrete class.
            var instance = registry.GetTheRawPacketIngestRepository_Internal();
