...
namespace MetWorks.ServiceRegistry
{
    ...
    internal static partial class TheWindRollupRepository_InstanceFactory
    {
        public static MetWorks.Persistence.Rollups.WindRollupRepository Create(Registry registry)
        {
            // Assignment-driven instance: construct with new().
            // This is always valid because ContainerClass is a concrete class.
            var instance = new MetWorks.Persistence.Rollups.WindRollupRepository();
            

            // Register immediately so other instances can reference it.
            registry.RegisterTheWindRollupRepository(instance);
